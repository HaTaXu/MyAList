...
FetchWebDev() {
  curl -L https://github.com/HaTaXu/MyAList-Web-dist/tar.gz/refs/heads/dev -o web-dist-dev.tar.gz
...
FetchWebRelease() {
  curl -L https://github.com/HaTaXu/MyAList-Web-dist/releases/latest/download/dist.tar.gz -o dist.tar.gz
